...
import {arrayUnion} from "@/Sets/arrayUnion";
...
export default function ArrayUnionPage() {
  ...
  const res = useMemo(() => {
    ...
    return arrayUnion([...a], [...b]); // copia defensiva por si muta
  }, [aInput, bInput]);

  return (
    <main style={{padding: 24}}>
      <h1>Sorted Array Union (live)</h1>
      <h2>Input</h2>
